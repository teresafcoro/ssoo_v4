...
// V4_EJERCICIO_1
int registerB_CPU; // Another general purpose register
...
void Processor_InitializeInterruptVectorTable(int interruptVectorInitialAddress) {
	...
	interruptVectorTable[CLOCKINT_BIT]=interruptVectorInitialAddress+4; // CLOCKINT_BIT=9, V2_EJERCICIO_2
}
...
int Processor_FetchInstruction() {
	...
	ComputerSystem_ShowTime(HARDWARE); // V2_EJERCICIO_1
...
void Processor_DecodeAndExecuteInstruction() {
	...
	switch (operationCode) {
		...
		case HALT_INST:
			// V1_EJERCICIO_16 
			// Se ejecuta unicamente cuando el procesador se encuentra en modo privilegiado
		...
		case OS_INST:			
			...
			// V3_EJERCICIO_2
			PID = OperatingSystem_GetExecutingProcessID();
		...
		// V1_EJERCICIO_0
		// Instruction MEMADD
		// Sintaxis: MEMADD operand1 memAddress
		case MEMADD_INST:
...
char * Processor_ShowPSW() {
	...
	if (Processor_PSW_BitState(INTERRUPT_MASKED_BIT))	// V2_EJERCICIO_3
